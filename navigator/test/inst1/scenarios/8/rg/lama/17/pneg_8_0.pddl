...
(:goal (and
( not (obp_MOVE_PLACE_2_2-PLACE_3_2))( not (obp_MOVE_PLACE_3_2-PLACE_4_2))( not (obp_MOVE_PLACE_4_2-PLACE_5_2))( not (obp_MOVE_PLACE_5_2-PLACE_6_2))( not (obp_MOVE_PLACE_6_2-PLACE_7_2))( not (obp_MOVE_PLACE_7_2-PLACE_8_2))( not (obp_MOVE_PLACE_8_2-PLACE_8_3))( not (obp_MOVE_PLACE_8_3-PLACE_8_4))( not (obp_MOVE_PLACE_8_4-PLACE_9_4))(AT PLACE_8_2)
))
)
