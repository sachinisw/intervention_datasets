...
(:goal (and
( not (obp_PICKUP_PLACE_0_0-KEY_1))( not (obp_PICKUP_PLACE_0_0-KEY_0))( not (obp_PICKUP_PLACE_0_0-KEY_2))( not (obp_MOVE_PLACE_0_0-PLACE_1_0))( not (obp_MOVE_PLACE_1_0-PLACE_2_0))( not (obp_MOVE_PLACE_2_0-PLACE_2_1))( not (obp_UNLOCK_PLACE_2_1-PLACE_2_2-KEY_2-SHAPE_2))( not (obp_MOVE_PLACE_2_1-PLACE_2_2))(AT-ROBOT PLACE_2_1)
))
)
