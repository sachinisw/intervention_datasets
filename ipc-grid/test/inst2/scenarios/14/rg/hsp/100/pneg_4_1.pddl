...
(:goal (and
( not (obp_PICKUP_PLACE_0_0-KEY_0))( not (obp_UNLOCK_PLACE_0_0-PLACE_0_1-KEY_0-SHAPE_0))( not (obp_PICKUP_PLACE_0_0-KEY_1))( not (obp_MOVE_PLACE_0_0-PLACE_1_0))( not (obp_MOVE_PLACE_1_0-PLACE_2_0))(AT-ROBOT PLACE_1_3)
))
)
