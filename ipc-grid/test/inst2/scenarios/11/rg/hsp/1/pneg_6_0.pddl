...
(:goal (and
( not (obp_PICKUP_PLACE_0_0-KEY_0))( not (obp_UNLOCK_PLACE_0_0-PLACE_0_1-KEY_0-SHAPE_0))( not (obp_PICKUP_PLACE_0_0-KEY_2))( not (obp_PICKUP_PLACE_0_0-KEY_1))( not (obp_MOVE_PLACE_0_0-PLACE_0_1))( not (obp_UNLOCK_PLACE_0_1-PLACE_1_1-KEY_1-SHAPE_1))( not (obp_MOVE_PLACE_0_1-PLACE_0_2))(AT-ROBOT PLACE_1_3)
))
)
