...
(:action ob__STACK_L-R
:parameters ()
:precondition (and (holding L)(clear R)(not (= L R))(obp_PICK-UP_L))
:effect (and (not (holding L))(not (clear R))(clear L)(handempty)(on L R)(obp_STACK_L-R))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_L-R))
