...
(:action ob__STACK_P-L
:parameters ()
:precondition (and (holding P)(clear L)(not (= P L))(obp_PICK-UP_P))
:effect (and (not (holding P))(not (clear L))(clear P)(handempty)(on P L)(obp_STACK_P-L))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_P-L))
