...
(:action ob__STACK_P-M
:parameters ()
:precondition (and (holding P)(clear M)(not (= P M))(obp_PICK-UP_P))
:effect (and (not (holding P))(not (clear M))(clear P)(handempty)(on P M)(obp_STACK_P-M))
)

(:action ob__PICK-UP_U
:parameters ()
:precondition (and (clear U)(ontable U)(handempty)(obp_STACK_P-M))
...
:parameters ()
:precondition (and (clear R)(ontable R)(handempty)(obp_STACK_U-P))
