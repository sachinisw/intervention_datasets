...
(:action ob__STACK_E-P
:parameters ()
:precondition (and (holding E)(clear P)(not (= E P))(obp_PICK-UP_E))
:effect (and (not (holding E))(not (clear P))(clear E)(handempty)(on E P)(obp_STACK_E-P))
)

(:action ob__PICK-UP_M
:parameters ()
:precondition (and (clear M)(ontable M)(handempty)(obp_STACK_E-P))
...
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_M-E))
