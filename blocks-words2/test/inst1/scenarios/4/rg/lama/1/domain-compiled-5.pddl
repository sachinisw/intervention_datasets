...
(:action ob__STACK_R-C
:parameters ()
:precondition (and (holding R)(clear C)(not (= R C))(obp_PICK-UP_R))
:effect (and (not (holding R))(not (clear C))(clear R)(handempty)(on R C)(obp_STACK_R-C))
)
