...
(:action ob__STACK_C-R
:parameters ()
:precondition (and (holding C)(clear R)(not (= C R))(obp_PICK-UP_C))
:effect (and (not (holding C))(not (clear R))(clear C)(handempty)(on C R)(obp_STACK_C-R))
)
