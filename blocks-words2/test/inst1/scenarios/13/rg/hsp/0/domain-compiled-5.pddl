...
(:action ob__STACK_R-P
:parameters ()
:precondition (and (holding R)(clear P)(not (= R P))(obp_PICK-UP_R))
:effect (and (not (holding R))(not (clear P))(clear R)(handempty)(on R P)(obp_STACK_R-P))
)

(:action ob__PICK-UP_U
:parameters ()
:precondition (and (clear U)(ontable U)(handempty)(obp_STACK_R-P))
...
:parameters ()
:precondition (and (clear C)(ontable C)(handempty)(obp_STACK_U-R))
