...
:parameters ()
:precondition (and (clear P)(ontable P)(handempty)(obp_STACK_C-U))
:effect (and (not (ontable P))(not (clear P))(not (handempty))(holding P)(obp_PICK-UP_P))
)

(:action ob__STACK_P-C
:parameters ()
:precondition (and (holding P)(clear C)(not (= P C))(obp_PICK-UP_P))
:effect (and (not (holding P))(not (clear C))(clear P)(handempty)(on P C)(obp_STACK_P-C))
)
