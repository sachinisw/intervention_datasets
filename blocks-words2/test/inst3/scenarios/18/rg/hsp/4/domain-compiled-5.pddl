...
(:action ob__STACK_W-R
:parameters ()
:precondition (and (holding W)(clear R)(not (= W R))(obp_PICK-UP_W))
:effect (and (not (holding W))(not (clear R))(clear W)(handempty)(on W R)(obp_STACK_W-R))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_W-R))
...
:parameters ()
:precondition (and (clear M)(ontable M)(handempty)(obp_STACK_A-W))
