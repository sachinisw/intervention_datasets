...
(:action ob__STACK_R-W
:parameters ()
:precondition (and (holding R)(clear W)(not (= R W))(obp_PICK-UP_R))
:effect (and (not (holding R))(not (clear W))(clear R)(handempty)(on R W)(obp_STACK_R-W))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_R-W))
...
:parameters ()
:precondition (and (clear M)(ontable M)(handempty)(obp_STACK_A-R))
