...
:parameters ()
:precondition (and (clear H)(ontable H)(handempty)(obp_STACK_W-O))
:effect (and (not (ontable H))(not (clear H))(not (handempty))(holding H)(obp_PICK-UP_H))
)

(:action ob__STACK_H-W
:parameters ()
:precondition (and (holding H)(clear W)(not (= H W))(obp_PICK-UP_H))
:effect (and (not (holding H))(not (clear W))(clear H)(handempty)(on H W)(obp_STACK_H-W))
)
