...
:parameters ()
:precondition (and (clear H)(ontable H)(handempty)(obp_STACK_C-E))
:effect (and (not (ontable H))(not (clear H))(not (handempty))(holding H)(obp_PICK-UP_H))
)

(:action ob__STACK_H-C
:parameters ()
:precondition (and (holding H)(clear C)(not (= H C))(obp_PICK-UP_H))
:effect (and (not (holding H))(not (clear C))(clear H)(handempty)(on H C)(obp_STACK_H-C))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_H-C))
