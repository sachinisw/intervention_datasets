...
:parameters ()
:precondition (and (clear R)(ontable R)(handempty)(obp_STACK_U-T))
...
:parameters ()
:precondition (and (clear H)(ontable H)(handempty)(obp_STACK_R-U))
:effect (and (not (ontable H))(not (clear H))(not (handempty))(holding H)(obp_PICK-UP_H))
)

(:action ob__STACK_H-R
:parameters ()
:precondition (and (holding H)(clear R)(not (= H R))(obp_PICK-UP_H))
:effect (and (not (holding H))(not (clear R))(clear H)(handempty)(on H R)(obp_STACK_H-R))
)
