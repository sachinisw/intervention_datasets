...
:parameters ()
:precondition (and (clear R)(ontable R)(handempty)(obp_STACK_E-A))
...
:parameters ()
:precondition (and (clear S)(ontable S)(handempty)(obp_STACK_R-E))
:effect (and (not (ontable S))(not (clear S))(not (handempty))(holding S)(obp_PICK-UP_S))
)

(:action ob__STACK_S-R
:parameters ()
:precondition (and (holding S)(clear R)(not (= S R))(obp_PICK-UP_S))
:effect (and (not (holding S))(not (clear R))(clear S)(handempty)(on S R)(obp_STACK_S-R))
)
