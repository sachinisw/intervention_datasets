...
:parameters ()
:precondition (and (not-eq L4 L3)(at-ferry L4)(obp_DEBARK_C1-L4))
...
:parameters ()
:precondition (and (not-eq L5 L6)(at-ferry L5)(obp_SAIL_L4-L5))
:effect (and  (at-ferry L6)(not (at-ferry L5))(obp_SAIL_L5-L6))
)

(:action ob__DEBARK_C2-L6
:parameters ()
:precondition (and  (on C2)(at-ferry L6)(obp_SAIL_L5-L6))
