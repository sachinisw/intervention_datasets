...
(:action ob__DEBARK_C2-L1
:parameters ()
:precondition (and  (on C2)(at-ferry L1)(obp_SAIL_L2-L1))
:effect (and (at C2 L1)(empty-ferry)(not (on C2))(obp_DEBARK_C2-L1))
)

(:action ob__BOARD_C1-L1
:parameters ()
:precondition (and  (at C1 L1)(at-ferry L1)(empty-ferry)(obp_DEBARK_C2-L1))
...
:parameters ()
:precondition (and (not-eq L4 L5)(at-ferry L4)(obp_SAIL_L3-L4))
