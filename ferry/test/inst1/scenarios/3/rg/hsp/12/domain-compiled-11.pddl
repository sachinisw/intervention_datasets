...
:parameters ()
:precondition (and (not-eq L1 L6)(at-ferry L1)(obp_SAIL_L2-L1))
:effect (and  (at-ferry L6)(not (at-ferry L1))(obp_SAIL_L1-L6))
)

(:action ob__DEBARK_C2-L6
:parameters ()
:precondition (and  (on C2)(at-ferry L6)(obp_SAIL_L1-L6))
:effect (and (at C2 L6)(empty-ferry)(not (on C2))(obp_DEBARK_C2-L6))
)

(:action ob__SAIL_L6-L1
:parameters ()
:precondition (and (not-eq L6 L1)(at-ferry L6)(obp_DEBARK_C2-L6))
