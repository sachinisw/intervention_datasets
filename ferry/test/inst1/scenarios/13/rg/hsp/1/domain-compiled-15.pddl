...
:parameters ()
:precondition (and  (on C2)(at-ferry L5)(obp_SAIL_L4-L5))
:effect (and (at C2 L5)(empty-ferry)(not (on C2))(obp_DEBARK_C2-L5))
)

(:action ob__SAIL_L5-L4
:parameters ()
:precondition (and (not-eq L5 L4)(at-ferry L5)(obp_DEBARK_C2-L5))
:effect (and  (at-ferry L4)(not (at-ferry L5))(obp_SAIL_L5-L4))
)
...
:parameters ()
:precondition (and (not-eq L3 L1)(at-ferry L3)(obp_SAIL_L4-L3))
