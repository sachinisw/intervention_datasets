...
(:action ob__STACK_O-R
:parameters ()
:precondition (and (holding O)(clear R)(not (= O R))(obp_PICK-UP_O))
:effect (and (not (holding O))(not (clear R))(clear O)(handempty)(on O R)(obp_STACK_O-R))
)

(:action ob__PICK-UP_A
:parameters ()
:precondition (and (clear A)(ontable A)(handempty)(obp_STACK_O-R))
...
:parameters ()
:precondition (and (clear M)(ontable M)(handempty)(obp_STACK_A-O))
