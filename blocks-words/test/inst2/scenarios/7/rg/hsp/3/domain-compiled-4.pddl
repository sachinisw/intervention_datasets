...
(:action ob__STACK_T-U
:parameters ()
:precondition (and (holding T)(clear U)(not (= T U))(obp_PICK-UP_T))
:effect (and (not (holding T))(not (clear U))(clear T)(handempty)(on T U)(obp_STACK_T-U))
)

(:action ob__PICK-UP_E
:parameters ()
:precondition (and (clear E)(ontable E)(handempty)(obp_STACK_T-U))
...
:parameters ()
:precondition (and (clear H)(ontable H)(handempty)(obp_STACK_E-T))
