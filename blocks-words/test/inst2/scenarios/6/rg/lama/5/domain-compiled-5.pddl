...
(:action ob__STACK_H-U
:parameters ()
:precondition (and (holding H)(clear U)(not (= H U))(obp_PICK-UP_H))
:effect (and (not (holding H))(not (clear U))(clear H)(handempty)(on H U)(obp_STACK_H-U))
)

(:action ob__PICK-UP_C
:parameters ()
:precondition (and (clear C)(ontable C)(handempty)(obp_STACK_H-U))
